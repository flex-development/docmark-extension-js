...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/docmark-extension-js
   cd docmark-extension-js
   ```
...
```sh
https://github.com/flex-development/docmark-extension-js/compare/main...$branch
```
